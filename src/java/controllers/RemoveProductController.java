...
public class RemoveProductController extends HttpServlet {
    ...
    private static final String ERROR_MESSAGE = "Cannot remove because of some issue!";
    private static final String SUCCESS_MESSAGE = "Remove product successfully!";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean checkProductID = productDAO.checkProductID(productID);
            boolean checkRemoveOrderDetail = true;
            if(checkProductID) {
                checkRemoveOrderDetail = productDAO.removeProductOrderDetail(productID);
            }
            if (checkRemoveOrderDetail) {
                boolean checkRemove = productDAO.removeProduct(productID);
                if (checkRemove) {
